...
function uploadPic(){
	...
	var options = {
			...
			$('#allUrl').attr("src",data[0]);
			$('#imgUrl').attr("value",data[0]);
...
<div class="body-box" style="float:right">
	<form id="jvForm" action="brandAdd.do" method="post" enctype="multipart/form-data">
			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						<td width="80%" class="pn-fcontent">
						<img width="100" height="100" id="allUrl" name="imgUrl"/>
