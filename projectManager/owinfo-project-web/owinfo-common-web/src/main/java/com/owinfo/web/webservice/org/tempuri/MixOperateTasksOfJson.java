...
@XmlRootElement(name = "MixOperateTasksOfJson")
public class MixOperateTasksOfJson {

    @XmlElementRef(name = "tasks", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> tasks;
     ...
     *     
     */
    public JAXBElement<String> getTasks() {
        return tasks;
    }
     ...
     *     
     */
    public void setTasks(JAXBElement<String> value) {
        this.tasks = value;
    }
